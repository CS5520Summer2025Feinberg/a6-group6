...
/**
 * Adapter for displaying received sticker messages in a RecyclerView. This adapter binds sticker
 * messages to views, showing the sender's name, sticker image, sticker name, and timestamp.
 */
public class ReceivedStickerAdapter extends
    RecyclerView.Adapter<ReceivedStickerAdapter.ViewHolder> {
  ...
  /**
   * Constructor for ReceivedStickerAdapter.
   *
   * @param context          The context in which the adapter is operating.
   * @param stickerMessages  The list of sticker messages to display.
   */
  ...
  /**
   * Initializes the sticker image and name mappings.
   * This method sets up the maps that associate sticker IDs with their corresponding drawable resources
   * and names.
   */
  ...
  /**
   * ViewHolder class for the ReceivedStickerAdapter.
   */
